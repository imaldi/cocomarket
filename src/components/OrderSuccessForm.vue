<template>
  <div class="bg-white">
    ...
    <div class="absolute justify-center flex w-full" style="bottom: 7rem">
      <div class="flex flex-col items-center">
        <a @click="cekReceipt()" class="text-[#7ACDD6] font-bold mb-2">Receipt</a>
        <div @click="reviewOrder()" class="text-center p-2 rounded-md w-[80vw] bg-[#7ACDD6] font-bold text-white">
          Review Order
        </div>
      </div>
    </div>

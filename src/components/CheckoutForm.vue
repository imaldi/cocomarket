      ...
      <div class="container pb-30">
        ...
        <div class="mx-8">
            <div class="my-6 ">
                ...
                <div class="bg-white -mt-6 px-4 py-6 rounded-xl flex">
                    ...
                    <div>
                    <button class="ml-12 bg-white border-[#E68027] text-color-[#E68027] rounded-full border-2 text-xs py-2 px-6">
                        Switch
                    </button>
                    </div>
                </div>
            ...
            <div class="flex px-2">
                <div class="w-1/2 justify-evenly">
                    ...
                    <div class="text-xs font-normal">Jl. Raya Batam Centre Blok A No. 10 Perumahan Taman Baloi Indah Batam, Kepulauan Riau 29432, Indonesia</div>
                </div>
                <div>
                    <button class="ml-10 bg-white border-[#E68027] text-color-[#E68027] rounded-full border-2 text-xs py-2 px-6">
                        Change
                    </button>
                </div>
            </div>
            ...
            <div>
                <div class="border-solid border border-gray rounded-2xl p-4 my-2">
                    ...
                    <div class="flex w-full justify-between mt-4">
                        <div class=" font-bold text-sm tracking-thighter">Rp. 15.000</div>
                        <div class="flex items-center">
                            <button class="shadow bg-white border-0 outline-0 py-0 px-2"><icon icon="ic:round-minus" color="#E68027" width="14" height="14" /></button>
                            <div class="text-sm color-gray mx-2">2</div>
                            <button class="shadow bg-[#E68027] border-0 outline-0 py-0 px-2"><icon icon="ic:round-plus" color="white" width="14" height="14" /></button>
                        </div>
                    </div>
                </div>
                <div class="border-solid border border-gray rounded-2xl p-4 my-2">
                ...
                <div class="border-solid border border-gray rounded-2xl p-4 my-2 flex">
                    ...
                    <button class="ml-14 bg-white border-[#E68027] text-color-[#E68027] rounded-full border-2 text-xs py-2 px-4">
                        Add More
                    </button>
                </div>
            </div>
        ...
        <div class="mx-8">
            <div class="border-solid border border-gray rounded-2xl p-4 my-2 flex items-center justify-between">
                ...
                <div class="border-solid border border-gray rounded-2xl rounded-b-0 border-b-0 p-4 mt-2 flex flex-col justify-between">
        ...
        <div class="fixed w-full bg-white rounded-lg shadow-md" style="bottom: 0">
                <div class="px-4 flex flex-row">
                    <div class="flex items-center">
                        <icon class="bg-[#E68027] p-2 rounded-full" icon="ep:wallet-filled" color="white" width="20" height="20" />
                        <div class="mx-4">
                    ...
                    <div class="flex items-center ml-8"><icon class="bg-black p-2 rounded-full" icon="solar:menu-dots-bold" color="white" width="20" height="20" /></div>
            </div>

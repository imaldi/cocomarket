  ...
  <div>
    <div class="container pb-106">
      ...
      <div class="flex px-8 py-6">
        <div
          class="px-6 py-2 bg-[#7ACDD6] rounded-2xl font-bold text-white text-sm"
        >
          All
        </div>
        <div
          class="px-4 py-2 bg-[#D9D9D9] rounded-2xl font-bold text-black text-sm mx-2"
        >
          Fresh Food
        </div>
        <div
          class="px-4 py-2 bg-[#D9D9D9] rounded-2xl font-bold text-black text-sm"
        >
          Storling
        </div>
      </div>
      ...
      >
        <div
          class="border border-solid border-gray p-4 rounded-2xl flex flex-col mb-2"
        >
          <div
            class="flex items-center justify-between border border-gray border-x-0 border-t-0 border-dashed pb-4"
          >
            <img
          ...
          <div class="flex justify-between items-center">
            ...
            <div>
              <div
                class="px-6 py-2 bg-[#E68027] text-white rounded-xl text-xs font-bold"
              >
                Rate
              </div>
            </div>

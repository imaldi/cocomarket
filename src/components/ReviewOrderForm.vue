    ...
    <div class="container pb-10">
      ...
      <div class="mx-8">
        ...
        >
          ...
          <div>
            <div class="text-[10px] text-black font-300">
              You are the 11th person to be served out of 11.
            </div>
            <div class="text-[10px] text-black font-semibold">
              Now Bakso Solo Kang Emil is serving the 8th person
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="mx-8">
        <div
          class="border-solid border border-gray rounded-2xl px-4 py-2 mb-4 flex flex-col justify-between"
        >
          <div
            class="font-bold text-sm border border-solid border-x-0 border-t-0 border-gray py-2"
          >
            Order Details
          </div>
        ...
        >
          <div
            class="flex justify-between border border-solid border-x-0 border-t-0 border-gray py-2"
          >
          ...
          <div class="flex items-center justify-between mb-2 text-sm">
            ...
            <div class="flex">
              <div
                class="font-bold text-[#E68027]"
                @click="router.push('trackorder')"
              >
                Track
              </div>
              <div>
            ...
            <div class="flex items-start mt-2">
              ...
              <div class="w-3/3">
                ...
                <div class="text-xs font-normal">
                  Jl. Raya Batam Centre Blok A No. 10 Perumahan Taman Baloi
                  Indah Batam, Kepulauan Riau 29432, Indonesia
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="px-4 mt-6">
          ...
          <div
            class="flex justify-between my-4 py-2 text-sm font-semibold border border-solid border-x-0 border-gray"
          >
            <div>SubTotal</div>
      ...
      <div class="relative">
        ...
        >
          <div class="flex w-full justify-between p-4">
            <div
              class="flex border-2 border-dashed border-red p-2 mr-8 rounded-2xl bg-white w-full justify-center"
            >

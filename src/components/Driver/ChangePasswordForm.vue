    ...
    <div class="container">
      <div class="bg-white shadow-md rounded-xl p-8">
        <div class="flex">
          ...
          <div class="w-full justify-center flex font-bold">Change Password</div>
        </div>
      </div>

      <div class="mx-8 my-6">
        <Form v-slot="{ errors }" class="flex flex-col px-2 pt-6">
          ...
          <Field
            ...
            placeholder="*********"
          />
          <div class="text-red-500 text-sm">Passwords tidak sesuai.</div>
